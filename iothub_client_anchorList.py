...
TIMEOUT = 241000
MINIMUM_POLLING_TIME = 9 #polls will happen at around 10 seconds

MESSAGE_TIMEOUT = 10000 #the maximum time in milliseconds until a message times out. The timeout period starts at IoTHubClient.send_event_async.
RECEIVE_CONTEXT = 0
AVG_WIND_SPEED = 10.0
MESSAGE_COUNT = 5
RECEIVED_COUNT = 0
...
METHOD_CALLBACKS = 0# String containing Hostname, Device Id & Device Key in t# String containing Hostname, Device Id & Device Key in the format:he format:

# chose HTTP, AMQP, AMQP_WS or MQTT as transport protocol
PROTOCOL = IoTHubTransportProvider.MQTT

# "HostName=<host_name>;DeviceId=<device_id>;SharedAccessKey=<device_key>"
CONNECTION_STRING = "HostName=IWizardsIOTHub.azure-devices.net;DeviceId=DG_INOUT;SharedAccessKey=f/bFT0JDB6pbGlLPKQpwOzNtjCwXorIqxeKqlZYwiIM="
    ...
    try:
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                msg_txt_formatted = MSG_TXT % (float(res1))
